...
SCHEMA_SQL = [
    ...
    guardian_lat DECIMAL(10, 8) DEFAULT NULL,
    guardian_lng DECIMAL(11, 8) DEFAULT NULL,
    guardian_radius_km DECIMAL(4, 2) DEFAULT 1.0,
    guardian_since TIMESTAMP NULL DEFAULT NULL
