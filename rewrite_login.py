...
.lp-ambient-core {
  ...
  background: radial-gradient(circle, rgba(139,92,246,0.15) 0%, rgba(139,0,0,0.05) 40%, transparent 70%);
...
.lp-orbit {
  ...
  border: 1px dashed rgba(139,92,246,0.2); transform: translate(-50%, -50%); pointer-events: none;
}
.lp-orbit-1 { width: 320px; height: 320px; animation: orbitSpin 15s linear infinite; }
.lp-orbit-2 { width: 440px; height: 440px; border: 1px solid rgba(139,92,246,0.1); animation: orbitSpin 25s linear infinite reverse; }
...
.lp-shield-svg {
  ...
  filter: drop-shadow(0 0 40px rgba(139,92,246,0.6)) drop-shadow(0 10px 20px rgba(0,0,0,0.8));
...
.lp-hero-badge {
  ...
  box-shadow: 0 0 20px rgba(139,92,246,0.1); backdrop-filter: blur(10px);
}
.lp-hero-badge-dot {
...
.lp-stat::before {
  content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, rgba(139,92,246,0.1), transparent);
  opacity: 0; transition: opacity 0.4s;
}
.lp-stat:hover { transform: translateY(-5px); box-shadow: 0 20px 40px rgba(139,92,246,0.2); }
...
.lp-btn-solid {
  padding: 8px 24px; border-radius: 8px; border: 1px solid rgba(139,92,246,0.5);
  background: rgba(139,92,246,0.15); color: #ff6b6b; font-size: 0.85rem; font-weight: 700; text-decoration: none;
  transition: all 0.3s; box-shadow: 0 0 15px rgba(139,92,246,0.2);
}
.lp-btn-solid:hover { background: rgba(139,92,246,0.3); color: #fff; transform: translateY(-2px); box-shadow: 0 0 25px rgba(139,92,246,0.4); }
...
.lp-fi-red { background: rgba(139,92,246,0.1); border: 1px solid rgba(139,92,246,0.2); color: #8b5cf6; }
...
@media (max-width: 1024px) {
  ...
  .lp-left { flex: 0 0 auto; min-height: 100vh; padding: 40px 20px; border-right: none; border-bottom: 1px solid rgba(139,92,246,0.15); }
  ...
  <div class="lp-left">
    ...
    <div class="lp-hero-assembly">
      ...
      <svg class="lp-shield-svg" viewBox="0 0 60 70" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="hRG1" cx="38%" cy="28%" r="65%"><stop offset="0%" stop-color="#ff6b6b"/><stop offset="45%" stop-color="#7c3aed"/><stop offset="100%" stop-color="#450a0a"/></radialGradient>
